...
* **Vorsicht**, Thema D-Sub-Verbindung zum LX: Je nachdem, welche Verbindung man benutzt ("PC" oder "Kolibri"), sind RX und LX vertauscht. Diese Platine ist so ausgelegt, dass das LX auf RS232-Pin 2 spricht und auf Pin 3 hört.
...
* Die Bluetooth-Module müssen vor Benutzung per AT-Kommandos auf die richtige Baudrate eingestellt werden (FLARM meist 19200 und LX meist 4800). Name des Bluetoothgeräts und PIN können auch gesetzt werden. Damit man mit dem LX bidirektional kommunizieren kann, muss die Baudrate der PC-Verbindung des LX auf 4800 gesetzt werden. Denn das LX wirft seine NMEA-Daten immer mit 4800 Baud aus, und kann aber mit konfigurierbarer Baudrate mit dem PC sprechen. Da das alles aber über das gleiche Bluetooth-Modul läuft, sollte 4800 Baud eingestellt sein.
